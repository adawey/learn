...
@section('pageTitle') Add Video @endsection
@section('subheaderTitle') Add Video @endsection
        ...
        <form class="vueform">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control" name="course" v-on:change="getChapters" v-model="course" id="exampleSelectd1">
