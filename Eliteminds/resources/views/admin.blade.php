    ...
    <div class="subheader py-3 py-lg-8 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                ...
                <!--begin::Button-->
                <a href="{{route('admin.inboxv2')}}" class="btn btn-success btn-icon font-weight-bold">
                            ...
                            <div class="card-spacer bg-white card-rounded flex-grow-1">
                                ...
                                <div class="row m-0">
                                    <div class="col px-8 py-6 mr-8">
                                        <div class="font-size-sm text-muted font-weight-bold">Total Profit</div>
                                        <div class="font-size-h4 font-weight-bolder">$ {{$p_num}} </div>
                                    </div>
                                    <div class="col px-8 py-6">
                                        <div class="font-size-sm text-muted font-weight-bold">Orders</div>
                                        <div class="font-size-h4 font-weight-bolder">{{$o_num}}</div>
                                    </div>
                                </div>
                                <!--end::Row-->
                                <!--begin::Row-->
                                <div class="row m-0">
                                    <div class="col px-8 py-6 mr-8">
                                        <div class="font-size-sm text-muted font-weight-bold">Users</div>
                                        <div class="font-size-h4 font-weight-bolder">{{$u_num}}</div>
                                    </div>
                                    <div class="col px-8 py-6">
                                        <div class="font-size-sm text-muted font-weight-bold">Questions</div>
                                        <div class="font-size-h4 font-weight-bolder">{{$q_num}}</div>
                                    </div>
                                </div>
                                <!--end::Row-->
                            </div>
