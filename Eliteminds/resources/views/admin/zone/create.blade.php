...
@section('pageTitle') Add Zone @endsection
@section('subheaderTitle') Add Zone @endsection
...
@section('content')
    ...
    <div class="row" style="background-color: white; padding: 0 0;">
        <div class="col-md-12">
            ...
            <form action="{{route('zone.store')}}" method="POST" class="form-horizontal" id="zoneForm" style="background: white; padding: 30px 15px;">
                @csrf
