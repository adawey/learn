...
@section('pageTitle') Edit Zone @endsection
@section('subheaderTitle') Edit Zone @endsection
@section('subheaderNav')
    <!--begin::Button-->
    <a href="#" onclick="document.getElementById('zoneForm').submit()" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    ...
    <!--begin::Button-->
    <a href="#" onclick="AVUtil().redirectionConfirmation('{{route('zone.index')}}')" class="btn btn-fh btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2">
    <span class="svg-icon svg-icon-success svg-icon-lg">
        <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
@section('content')
    ...
    <div class="row" style="background-color: white; padding: 0 0;">
        <div class="col-md-12">
            ...
            <form action="{{route('zone.update', $zone->id)}}" method="POST" class="form-horizontal" id="zoneForm" style="background: white; padding: 30px 15px;">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    <label class="col-2 col-form-label">Name</label>
                    <div class=" col-10">
                        <input type="text" class="form-control input-sm" name="name" value="{{$zone->name}}">
                ...
                <div class="form-group row">
                    <label class="col-2 col-form-label">Countries</label>
                    <div class=" col-10">
                        <select class="form-control select2" id="kt_select2_3" name="countries[]" multiple="multiple">
                            <optgroup>
                                @foreach($thisZoneCountries as $country)
