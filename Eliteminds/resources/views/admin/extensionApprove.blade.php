...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height:1318px">
        ...
        <!--        </li>-->
        <!--        <li>-->
        <!--            <a href="#">Extension Payment approve</a>-->
        <!--            <i class="fa fa-circle"></i>-->
        <!--        </li>-->
        <!--    </ul>-->
        ...
        <div style="background: white; padding: 30px 15px; height: auto;">
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @if(count(\App\PaymentExtensionApprove::all()) ) 
                            @foreach(\App\PaymentExtensionApprove::orderBy('created_at', 'desc')->get() as $approve)
                            @if(\App\User::find($approve->user_id))
                                <tr>
                                    ...
                                    <td>{{ $approve->created_at->diffForHumans() }}</td>
                                    <td>
                                        <a href="{{ route('extension.payment.approve', $approve->id) }}">Approve</a>   |   
                                        <a style="color:brown;" href="{{ route('extension.payment.cancel', $approve->id) }}">Cancel</a>
                                    </td>
                                </tr>
                            @endif
                            @endforeach
