...
@section('pageTitle') New Coupon @endsection
@section('subheaderTitle') New Coupon @endsection
...
@section('content')
    ...
    <div class="row" style="background-color: white; padding: 0 0;">
        <div class="col-md-12">
            ...
            <form action="{{ route('coupon.generate') }}" id="newCouponForm" method="POST" class="form-horizontal" style="background: white; padding: 30px 15px;">
                @csrf
                ...
                <div class="form-group form-md-line-input">
                    <label class="col-md-2 control-label" for="package_id">Course (optional):</label>
                    <div class="col-md-8">
                ...
                <div class="form-group form-md-line-input">
                    <label class="col-md-2 control-label" for="event_id">Event (optional) :</label>
                    <div class="col-md-8">
