...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | es lignes de langue suivantes sont utilisées lors de l'authentification pour divers
    | messages que nous devons afficher à l'utilisateur.
    | Vous êtes libre de modifier ces lignes de langue en fonction des besoins de votre application.
    |
    */
